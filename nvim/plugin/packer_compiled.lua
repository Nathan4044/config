...
_G.packer_plugins = {
  ...
  ["lsp-zero.nvim"] = {
    loaded = true,
    path = "/Users/nathan/.local/share/nvim/site/pack/packer/start/lsp-zero.nvim",
  ...
  playground = {
    loaded = true,
    path = "/Users/nathan/.local/share/nvim/site/pack/packer/start/playground",
  ...
  ["rose-pine"] = {
    ...
    loaded = true,
    path = "/Users/nathan/.local/share/nvim/site/pack/packer/start/rose-pine",
